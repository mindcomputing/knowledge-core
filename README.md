...
```
mvn jgitflow:release-start jgitflow:release-finish -DreleaseVersion=uts-5.18 -DdevelopmentVersion=uts-5.19-SNAPSHOT -DaltDeploymentRepository=awsnexus::default::http://52.61.167.217:9092/nexus/content/repositories/releases
