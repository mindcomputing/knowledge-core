...
```
mvn -B gitflow:release-start gitflow:release-finish -DreleaseVersion=6.33-uts -DdevelopmentVersion=6.34-uts-SNAPSHOT -DargLine=-DaltDeploymentRepository=awsnexus::default::http://mindcomputing.net:9092/nexus/content/repositories/releases -DpostReleaseGoals="clean deploy"
